...
public class PublicCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String lbl, String[] args) {
        if(sender instanceof Player) {
            ...
            if(!player.hasPermission("trinity.essentials.public")) {
            ...
            try {
                ...
                homeDAO.changeHomePublicStatus(playerUUID, homeName, true);
                player.sendMessage(ChatColor.GREEN + "Sua home " + homeName + " foi definida como publica. Para desfazer utilize /private.");
                return true;
            } catch (Exception e) {
                player.sendMessage(ChatColor.RED + "Ocorreu um erro ao transformar sua home como publica. Tente novamente.");
